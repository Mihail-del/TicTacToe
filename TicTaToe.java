...
public class TicTaToe extends GraphicsProgram {
    ...
    // ===== COLORS =====
    Color bgColor = new Color(246, 231, 200);
    Color menuColor = new Color(154, 148, 135);
    ...
    boolean choiceScreenWait = false;
    ...
    int cellOneMinY;
    int cellOneMaxY;
    boolean cellOneFree = true;
    String cellOneContent = "1";
    ...
    int cellTwoMinY;
    int cellTwoMaxY;
    boolean cellTwoFree = true;
    String cellTwoContent = "2";
    ...
    int cellThreeMinY;
    int cellThreeMaxY;
    boolean cellThreeFree = true;
    String cellThreeContent = "3";
    ...
    int cellFourMinY;
    int cellFourMaxY;
    boolean cellFourFree = true;
    String cellFourContent = "4";
    ...
    int cellFiveMinY;
    int cellFiveMaxY;
    boolean cellFiveFree = true;
    String cellFiveContent = "5";
    ...
    int cellSixMinY;
    int cellSixMaxY;
    boolean cellSixFree = true;
    String cellSixContent = "6";
    ...
    int cellSevenMinY;
    int cellSevenMaxY;
    boolean cellSevenFree = true;
    String cellSevenContent = "7";
    ...
    int cellEightMinY;
    int cellEightMaxY;
    boolean cellEightFree = true;
    String cellEightContent = "8";
    ...
    int cellNineMinY;
    int cellNineMaxY;
    boolean cellNineFree = true;
    String cellNineContent = "9";
